...
QT_MOC_LITERAL(1, 10, 13), // "readResultXML"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 9) // "readyRead"

    },
    "ClientTcp\0readResultXML\0\0readyRead"
};
...
void ClientTcp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientTcp::readResultXML)) {
                *result = 0;
                return;
            }
        }
